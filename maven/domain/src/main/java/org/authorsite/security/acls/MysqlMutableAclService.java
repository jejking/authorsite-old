 ...
 */
package org.authorsite.security.acls;
 ...
 * @author John King
 */
public class MysqlMutableAclService extends JdbcAclService implements MutableAclService {
    //~ Instance fields ================================================================================================
    ...
    private String identityQuery = "SELECT LAST_INSERT_ID()";
    ...
    public MysqlMutableAclService(DataSource dataSource, LookupStrategy lookupStrategy, AclCache aclCache) {
