...
public interface WebResourceService {
    ...
    @Transactional(readOnly = true)
    public abstract List<WebResource> findWebResourcesBetweenDates(Date startDate, Date endDate)
    ...
    @Transactional(readOnly = true)
    public abstract List<WebResource> findWebResourcesWithAuthorOrEditor(AbstractHuman human)
            throws DataAccessException;
