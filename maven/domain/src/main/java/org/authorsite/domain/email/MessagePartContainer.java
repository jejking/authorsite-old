...
public class MessagePartContainer extends AbstractEmailPart {
     ...
     */
    private static final long serialVersionUID = 2049797748027367459L;
    ...
    @Override
    public int hashCode() {
	return new HashCodeBuilder().append(this.children.toArray()).toHashCode();
    }
	...
	for (AbstractEmailPart part : this.children) {
	    buffer.append(part);
	}
