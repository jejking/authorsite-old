...
final class WebResource extends AbstractAuthoredEditedPublishedWork {
    ...
    static function getPage($pageNumber, $pageSize, $db) {
        $coreResultSet = AbstractEntry::doPagingQuery(WebResource::GET_WEBRESOURCES_CORE_QUERY, $pageNumber, $pageSize, $db);
        $resultArray = array();
    ...
    private static function buildWebResource($coreResultSetRow, $workProducers) {
        ...
        return new WebResource($id, $title, $fromDate, $toDate, $authors, $editors, $publisher, $url, $lastChecked, $lastStatusCode);
