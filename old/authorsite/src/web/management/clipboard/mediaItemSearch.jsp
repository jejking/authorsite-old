...
<!-- $Header: /cvsroot/authorsite/authorsite/src/web/management/clipboard/mediaItemSearch.jsp,v 1.1 2003/03/29 13:54:46 jejking Exp $
     Author: jejking
...
<doc xmlns:html="/WEB-INF/struts-html.tld"
    ...
    <ia>
        <title><bean:message key="web.management.clipboard.mediaItemSeach.pageTitle"/></title>
    </ia>    
    <block id="main">    
        <h1><bean:message key="web.management.clipboard.mediaItemSeach.pageHeader"/></h1> 
        
        <bean:message key="web.bibPublic.mediaItemSearch.blurb"/>
        <html:errors/>

        <html:form action="/management/clipboard/mediaItemSearch">
        <table>
            <tr>
                <td>
