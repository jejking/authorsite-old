...
<!-- $Header: /cvsroot/authorsite/authorsite/src/web/management/clipboard/selectLanguagesTwo.jsp,v 1.3 2003/03/29 13:54:46 jejking Exp $
     Author: jejking
...
<doc xmlns:html="/WEB-INF/struts-html.tld"
    ...
    <block id="main">    
        ...
        <!-- according to whether priority is 2 or 3, iterate through languagesTwoBean or languagesThreeBean -->
        <h2><bean:message key="web.management.clipboard.priority2languagesHeader"/></h2>
        <table>
            <html:form action="/management/clipboard/addLangsToClipboard">
                <logic:iterate id="language" name="languagesTwoList" scope="application">
                    <tr>
                        <td>
         ...
         <p>
            <html:link action="/management/clipboard/selectLanguagesThree"><bean:message key="web.management.clipboard.selectLangs.moreLangsLink"/></html:link>
         </p>
    </block>
