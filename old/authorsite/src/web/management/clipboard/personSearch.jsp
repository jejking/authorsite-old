...
<!-- $Header: /cvsroot/authorsite/authorsite/src/web/management/clipboard/personSearch.jsp,v 1.2 2003/03/29 13:54:46 jejking Exp $
    Author: jejking
...
<doc xmlns:html="/WEB-INF/struts-html.tld"
    ...
    <ia>
        <title><bean:message key="web.management.clipboard.personSearch.pageTitle"/></title>
    </ia>    
    <block id="main">    
        <h1><bean:message key="web.management.clipboard.personSearch.pageHeader"/></h1>   
            
            <html:errors/>
            <html:form action="/management/clipboard/personSearch">
                <table>
                    <tr>
                        <td>
