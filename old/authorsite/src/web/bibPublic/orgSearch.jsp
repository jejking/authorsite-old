...
<!-- $Header: /cvsroot/authorsite/authorsite/src/web/bibPublic/orgSearch.jsp,v 1.2 2003/03/29 13:28:58 jejking Exp $
    Author: jejking
...
<doc xmlns:html="/WEB-INF/struts-html.tld"
    ...
    <ia>
        <title><bean:message key="web.bibPublic.orgSearch.pageTitle"/></title>
    </ia>    
    <block id="main">    
        <h1><bean:message key="web.bibPublic.orgSearch.pageHeader"/></h1>   
            
            <html:errors/>
            <html:form action="/public/orgSearch">
                <table>
                    <tr>
                        <td>
