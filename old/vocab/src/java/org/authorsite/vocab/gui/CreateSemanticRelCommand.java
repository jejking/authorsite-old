/*
 * CreateSemanticRelCommand.java, created on 18-Nov-2003 at 22:44:13
 * 
 * Copyright John King, 2003.
 *
 *  CreateSemanticRelCommand.java is part of authorsite.org's VocabManager program.
 *
 ...
 */
public class CreateSemanticRelCommand implements VocabCommand {

	private SemanticRelDTO relDTO;
	private VocabSet vocabSet;

	public CreateSemanticRelCommand(SemanticRelDTO relDTO) {
		this.relDTO = relDTO;
	}
	...
	public void execute(VocabMediator mediator) throws VocabException {
		...
		fromNode.createSemanticRel(toNode, relDTO.getRelationshipType());
	...
	public VocabEventType getEventType() {
		return VocabEventType.REL_CREATED;
	}
