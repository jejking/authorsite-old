/*
 * PersonImpl.java, created on 07-Mar-2004 at 13:34:06
 * 
 * Copyright John King, 2004.
 *
 *  PersonImpl.java is part of authorsite.org's MailArchive program.
 *
...
public final class PersonImpl implements Person, Versionable, Comparable {
	...
	public void setGenderCode(int newGenderCode) {
		if (newGenderCode < 0 || (newGenderCode > 2 && newGenderCode != 9)) {
			...
			newGenderCode = 0; // set it to 0, 'not-known'
		}
	...
	public boolean equals(Object o) {
		...
		if (o instanceof Person) {
			...
			return new EqualsBuilder()
				.append(givenName, input.getGivenName())
				.append(mainName, input.getMainName())
				.append(otherNames, input.getOtherNames())
				.append(dateOfBirth, input.getDateOfBirth())
				.append(dateOfDeath, input.getDateOfDeath())
				.isEquals();
		}
		else {
			return false;
	...
	public int compareTo(Object o) {
		...
		return new CompareToBuilder()
			.append(givenName, input.givenName)
			.append(mainName, input.mainName)
			.append(otherNames, input.otherNames)
			.append(dateOfBirth, input.dateOfBirth)
			.append(dateOfDeath, input.dateOfDeath)
			.toComparison();
	}
